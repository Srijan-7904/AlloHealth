  ...
  async function startRazorpayCheckout() {
    ...
    try {
      ...
      const razorpay = new window.Razorpay({
        ...
        modal: {
          ondismiss: () => {
            pushToast({ title: 'Payment cancelled', description: 'Checkout window was closed.', variant: 'info' });
          }
        },
        prefill: {
          name: 'Customer'
      ...
      <section className="reserve-panel">
        ...
        <div className="field-group">
          ...
          <div className="quantity-stepper">
            <button type="button" className="stepper-button" onClick={() => setQuantity((value) => Math.max(1, value - 1))}>
              −
            </button>
            <input
              id="quantity"
            ...
            />
            <button type="button" className="stepper-button" onClick={() => setQuantity((value) => value + 1)}>
              +
            </button>
          </div>
        </div>
        ...
        <div className="action-row">
          ...
          <button onClick={() => router.push('/products')} className="button button--secondary button--wide">
            Back to products
          </button>
        </div>
        ...
        {reservation && (
          <div className="reservation-card">
            ...
            <div className="action-row action-row--stacked">
              ...
              <button onClick={releaseReservation} className="button button--ghost button--wide">
                Cancel reservation
              </button>
            </div>
          </div>
            ...
            <div className="test-checkout__header">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  pushToast({ title: 'Payment cancelled', description: 'Checkout was closed.', variant: 'info' });
                }}
              >
                ×
              </button>
